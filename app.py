...
with st.sidebar:
    ...
    st.divider()
    st.markdown("**📥 Distributions Nemotron**")
    st.caption("Remplace les estimations EMP/CGDD. Généré par le notebook Colab.")
...
with tab3:
    ...
    st.markdown("Choisissez un persona et découvrez quels véhicules Vélis lui correspondent — score /120, réaction IA.")
    st.divider()
